...
public class NoteShareServiceImpl extends ServiceImpl<NoteShareMapper, NoteShare> implements NoteShareService {
    ...
    public Result<Object> getNoteIsShare(Integer noteId) {
        ...
        if (isShare == 1){
            ...
            //已经分享过了
            String noteShareKey = "note_share_key_" + userId + "_" + noteId;
    ...
    public Result<Object> addNoteShare(NoteShareAddDTO noteShareAddDTO) {
        ...
        String noteShareKey = "note_share_key_" + UserContext.getUserId() + "_" + noteId;
        if (redisCache.hasKey(noteShareKey)){
    ...
    //获取分享笔记的信息
    @Override
    public Result<Object> getShareNote(NoteShareGetDTO noteShareGetDTO) {
    ...
    //点赞和取消点赞
    @Override
    public Result<Object> goToLick(NoteShareLickDTO noteShareLickDTO) {
